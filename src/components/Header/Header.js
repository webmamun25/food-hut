      ...
      <Container className='navmenu'>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav>
            ...
            <NavLink >
            {
                  props.user ? <button onClick={()=>props.handleSignout()} style={{borderRadius:"25px",backgroundColor:"#e9496e",border:"2px solid white",width:'120px',color:"white"}}>Sign Out</button>:<button onClick={()=>props.handlegoogleSignin()} style={{borderRadius:"25px",backgroundColor:"#e9496e",border:"2px solid white",width:'120px',color:"white"}}>Sign In</button>
                }
            </NavLink>
            <Navbar.Brand >
                {
